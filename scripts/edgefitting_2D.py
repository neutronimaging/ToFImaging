...
def image_edge_fitting(pathdata, pathob, filemask, pathspectrum, cal_parameters, binning, lambda_range, est_parameters):
...
#         print('processing row n. ', i, 'of', np.shape(mymask)[0])
    ...
    return {'edge_position' : edge_position, 'edge_height': edge_height}
